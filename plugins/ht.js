let handler = async (m, { conn, text }) => {
  ...
  if (m.chat in conn.hartatahta) throw 'Alguém ainda está fazendo\nTexto Trono do Tesouro\nneste bate-papo... aguarde até terminar'
  else conn.hartatahta[m.chat] = true
  m.reply('_Está fazendo..._\n*Por favor, aguarde cerca de 1 minuto*')
  try {
    let img = await ht(text ? text : ':v')
    conn.sendFile(m.chat, img, 'Harta Tahta.png', '*© Icaro*\nFeito com FFmpeg', m)
  } finally {
